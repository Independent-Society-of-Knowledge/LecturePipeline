...
def leftCompact(configuration: LectureConfiguration = LectureConfiguration("/home/kid-a/Documents/isk/LecturePipeline/resources/testconf.yml"),
                title: str = "Title",
                 subtitle: str = "Subtitle",
                 duration: float = 4
                 ):
    class LeftCompactScene(Scene):
        def setup(self):
            self.title = title
        ...
        def construct(self):
            ...
            rectangle = Rectangle(width=percent_to_units(60, config), height=percent_to_units(50, config),
            ...
            self.add(background)
            self.play(Transform(
                Rectangle(width=0, height=percent_to_units(50, config), stroke_width=0, fill_opacity=0).move_to(LEFT * 8,
                                                                                                                 aligned_edge=LEFT),
