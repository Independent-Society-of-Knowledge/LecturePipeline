...
def rightCompact(configuration: LectureConfiguration = LectureConfiguration(
        "/home/kid-a/Documents/isk/LecturePipeline/resources/testconf.yml"),
                 title: str = "Title",
                 subtitle: str = "Subtitle",
                 duration: float = 4
                 ):
    class RightCompactScene(Scene):
        ...
        def construct(self):
            ...
            rectangle = Rectangle(width=percent_to_units(60, config), height=percent_to_units(50, config, dimension="height"),
            ...
            self.add(background)
            self.play(Transform(
                Rectangle(width=0, height=percent_to_units(50, config, "height"), stroke_width=0, fill_opacity=0).move_to(RIGHT * 8,
                                                                                                                 aligned_edge=RIGHT),
